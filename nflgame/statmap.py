...
def values(category_id, yards):
    ...
    """
    assert category_id in idmap, "Category identifier %d is not known." % category_id
...
idmap = {
    ...
    52: {
        ...
        "yds": "",
        "desc": "Fumble - forced",
        "long": "Player fumbled the ball, fumble was forced by another " "player.",
    },
    53: {
        "cat": "fumbles",
        ...
        "long": "Player fumbled the ball, fumble was not forced by another " "player.",
    },
    54: {
        "cat": "fumbles",
        "fields": ["fumbles_oob"],
    ...
    62: {
        ...
        "long": "Same as previous, except when the play results in a " "touchdown.",
    },
    63: {
        "cat": "defense",
        "fields": [],
    ...
    74: {
        ...
        "long": "Extra point blocked. Exclusive of the extra point failed " "stat.",
    },
    75: {
        "cat": "rushing",
    ...
    89: {
        ...
        "yds": "",
        "desc": "Safety (defense)",
        "long": "Tackle that resulted in a safety. This is in addition to " "a tackle.",
    },
